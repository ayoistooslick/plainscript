# PlainScript Game Development Prompt Guide (v1.0.363)
...
PlainScript**. v1.0.363 reaches into any JS API from `.pln`, which makes
...
v1.0.363 adds hex literals (`0xRRGGBB`): numeric colors use `0xffffff` instead
