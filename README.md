...
Describe *what* you want. The compiler decides *how* to implement it with high performance and **frontier AI token efficiency**.
...
```text
compiler/                 lexer, parser, generator, CLI, bundler, LSP, Wasm
